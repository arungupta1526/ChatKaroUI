...
//                 (s, start, end, groups) -> wrapSpan(ssb, start, end, groups[0], new StyleSpan(Typeface.BOLD)));
//         applyPattern(ssb, P_BOLD_UNDER,
//                 (s, start, end, groups) -> wrapSpan(ssb, start, end, groups[0], new StyleSpan(Typeface.BOLD)));
//         applyPattern(ssb, P_ITALIC_STAR,
//                 (s, start, end, groups) -> wrapSpan(ssb, start, end, groups[0], new StyleSpan(Typeface.ITALIC)));
//         applyPattern(ssb, P_ITALIC_UNDER,
//                 (s, start, end, groups) -> wrapSpan(ssb, start, end, groups[0], new StyleSpan(Typeface.ITALIC)));
//         applyPattern(ssb, P_STRIKE,
//                 (s, start, end, groups) -> wrapSpan(ssb, start, end, groups[0], new StrikethroughSpan()));
...
//                 .compile(java.util.regex.Pattern.quote(CODE_PLACEHOLDER_PREFIX) + "(\\d+)\u0000").matcher(str);
...
//                 java.util.regex.Pattern.quote(startMarker) + "(.*?)" + java.util.regex.Pattern.quote(endMarker));
